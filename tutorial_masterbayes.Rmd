...
# 4) Make the pedigree
### Give this command your PdataPed, GdataPed, and Initialized object to make the pedigree. 
### Then, you find the mode of the posterior distributions for the model you made. 
