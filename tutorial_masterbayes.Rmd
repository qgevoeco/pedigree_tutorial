...
First step - Read in your data.
One matrix with Genotypic data, one with Phenotypic data.
...
#Use which to identify any discrepencies in the pedigree's topology between the two models
discrepancies_topology<-which(US20_Parentage[,1:3]!=Est_US_Parentage[,1:3])
discrepancies

#Use which to identify any discrepencies in the probability of assignment. 
